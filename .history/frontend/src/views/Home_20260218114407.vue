      ...
      <div class="container mx-auto">
        ...
        <div ref="scrollContainer" class="flex gap-10 overflow-x-auto pb-8 scrollbar-hide snap-x">
          <div v-for="cat in categories" :key="cat.id" 
            ...
            <img :src="cat.image || placeholderImage" :alt="cat.name || 'Category'" class="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" @error="(e: Event) => (e.target as HTMLImageElement).src = placeholderImage" />
...
import { productService, PLACEHOLDER_IMAGE } from '@/services/products'
