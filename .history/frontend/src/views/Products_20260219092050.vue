...
<template>
  <div class="min-h-screen bg-[#FDFCFB] text-[#2C1810] pb-32 selection:bg-amber-100">
    ...
    <div class="container mx-auto px-6 py-16">
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        ...
        >
       <div class="relative aspect-square overflow-hidden group-hover:shadow-2xl transition-all duration-700">
  <img 
  ...
  <div v-if="product.stock === 0" class="absolute inset-0 bg-black/40 flex items-center justify-center">
    <span class="text-white text-xs font-bold uppercase tracking-widest px-4 py-2 border border-white/30 backdrop-blur-md">
      Out of Stock
    </span>
  </div>
</div>
