...
use App\Http\Controllers\MoceanController;   // ← Add this line
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Basic user info & session management
...
// ────────────────────────────────────────────────
Route::middleware('auth:sanctum')->group(function () {
    Route::post('/sms/send', [SmsController::class, 'send'])->middleware('can:manage-orders');
    Route::get('/sms/test', [SmsController::class, 'test'])->middleware('can:manage-orders');
});
